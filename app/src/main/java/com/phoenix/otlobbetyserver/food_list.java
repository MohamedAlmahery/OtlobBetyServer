...
import com.phoenix.otlobbetyserver.Model.Food;
import com.phoenix.otlobbetyserver.ViewHolder.FoodViewHolder;
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(food_list.this, "Upload !!!", Toast.LENGTH_SHORT).show();
